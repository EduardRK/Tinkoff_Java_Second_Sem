...
class LinkUntrackCommandChainTest {

    @ParameterizedTest
    @CsvSource(value = {
        "https://stackoverflow.com/questions/40471/what-are-the-differences-between-a-hashmap-and-a-hashtable-in-java?rq=1, Link is being untracked, false",
    ...
    void start(String userMessage, String response, boolean nextExpected) {
        ...
        LinkUntrackCommandChain chain = new LinkUntrackCommandChain(message);
